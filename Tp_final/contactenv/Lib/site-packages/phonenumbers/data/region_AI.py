...
PHONE_METADATA_AI = PhoneMetadata(id='AI', country_code=1, international_prefix='011',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='264(?:235|4(?:69|7[67])|5(?:3[6-9]|8[1-4])|7(?:29|72))\\d{4}', example_number='2642351234', possible_length=(10,), possible_length_local_only=(7,)),
