...
PHONE_METADATA_BO = PhoneMetadata(id='BO', country_code=591, international_prefix='00(?:1\\d)?',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[2-7]\\d\\d|8001)\\d{5}', possible_length=(8, 9), possible_length_local_only=(7,)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:57|[67]\\d)\\d{6}', example_number='71234567', possible_length=(8,)),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{7})', format='\\1 \\2', leading_digits_pattern=['[23]|4[46]|50'], domestic_carrier_code_formatting_rule='0$CC \\1'),
        NumberFormat(pattern='(\\d{8})', format='\\1', leading_digits_pattern=['[5-7]'], domestic_carrier_code_formatting_rule='0$CC \\1'),
